...
enum EClientReqCommand
{
    ...
    //WAVE@20161226
    EN_CLIENT_OPERATE_CMD__MINUS_TROOP_ARRAY,
    EN_CLIENT_OPERATE_CMD__ADD_BUF_TIME,
    ...
    EN_CLIENT_OP_CMD__SET_THRONE_PEACE_TIME,
    ...
    EN_OP_GET_RANK,
    EN_OP_RECALL_INVALID_RALLY_REINFORCE,

    EN_OPSELF_SET_PEACE_TIME,

    EN_CLIENT_REQ_COMMAND__GET_LORD_IMAGE,
    EN_CLIENT_REQ_COMMAND__BUILD_DECORATION,
    EN_CLIENT_REQ_COMMAND__OPEN_DECORATION_LIST,
    EN_CLIENT_REQ_COMMAND__DELETE_DECORATION,

    EN_CLIENT_REQ_COMMAND__GIVE_GIFT,
    EN_CLIENT_OP_CMD__DELETE_ACTION,

    EN_OP_MAIL_SEND_GIFT,
    EN_OP_MAIL_PICK_UP_GIFT,
    EN_OP_CLEAR_DECORATION,
    EN_OP_DELETE_LORD_IMAGE,
    EN_OPSELF_SET_IAP_PROMOTE_NUM,

    EN_CLIENT_REQ_COMMAND__UNLOCK_VIP_STAGE,
    EN_CLIENT_REQ_COMMAND__VIP_OPEN_CHEST,
    EN_CLIENT_REQ_COMMAND__SEND_EVENT_SCORE,

    EN_OPSELF_SET_VIP_POINT,

    EN_CLIENT_REQ_COMMAND__LORD_SKILL_UPGRADE_NEW,
    EN_CLIENT_REQ_COMMAND__DRAGON_SKILL_UPGRADE_NEW,
    EN_CLIENT_REQ_COMMAND__DRAGON_MONSTER_SKILL_UPGRADE_NEW,
