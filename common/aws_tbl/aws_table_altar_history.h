#ifndef _AWS_TABLE_ALTAR_HISTORY_H_
#define _AWS_TABLE_ALTAR_HISTORY_H_

#include "aws_table_common.h"
#include "field_property.h"

#define EN_AWS_TABLE_ALTAR_HISTORY "altar_history"

enum ETbAltar_historyField
{
	TbALTAR_HISTORY_FIELD_UID = 0,
	TbALTAR_HISTORY_FIELD_TIME = 1,
	TbALTAR_HISTORY_FIELD_CONTENT = 2,
	TbALTAR_HISTORY_FIELD_SEQ = 3,
};

enum ETbAltar_historyOpenType
{
	ETbALTARHISTORY_OPEN_TYPE_PRIMARY = 0,
};

class TbAltar_history : public AwsTable
{
public:
	TINT64 m_nUid;
	TINT64 m_nTime;
...
public:
	TbAltar_history():AwsTable(&oTableDesc)
	{
		Reset();
	}
	~TbAltar_history()
	...
	{
		m_jContent = jContent;
		m_mFlag[TbALTAR_HISTORY_FIELD_CONTENT] = jContent.empty() ? UPDATE_ACTION_TYPE_DELETE : UPDATE_ACTION_TYPE_PUT;
	}
	...
	{
		m_nSeq = nSeq;
		m_mFlag[TbALTAR_HISTORY_FIELD_SEQ] = dwActionType;
	}
	//Scan命令使用,返回完整的请求包
