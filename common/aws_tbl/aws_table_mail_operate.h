#ifndef _AWS_TABLE_MAIL_OPERATE_H_
#define _AWS_TABLE_MAIL_OPERATE_H_

#include "aws_table_common.h"
#include "field_property.h"

#define EN_AWS_TABLE_MAIL_OPERATE "mail_operate"

enum ETbMail_operateField
{
	TbMAIL_OPERATE_FIELD_UID = 0,
	TbMAIL_OPERATE_FIELD_LIST = 1,
	TbMAIL_OPERATE_FIELD_SYSTEM_LIST = 2,
	TbMAIL_OPERATE_FIELD_AL_LIST = 3,
	TbMAIL_OPERATE_FIELD_SEQ = 4,
};

enum ETbMail_operateOpenType
{
	ETbMAILOPERATE_OPEN_TYPE_PRIMARY = 0,
};

#define	TBMAIL_OPERATE_LIST_MAX_NUM	1
typedef	BinBuf<SMailOperateList, TBMAIL_OPERATE_LIST_MAX_NUM>		TbMail_operate_List;

#define	TBMAIL_OPERATE_SYSTEM_LIST_MAX_NUM	1
typedef	BinBuf<SMailOperateList, TBMAIL_OPERATE_SYSTEM_LIST_MAX_NUM>		TbMail_operate_System_list;

#define	TBMAIL_OPERATE_AL_LIST_MAX_NUM	1
typedef	BinBuf<SMailOperateList, TBMAIL_OPERATE_AL_LIST_MAX_NUM>		TbMail_operate_Al_list;

class TbMail_operate : public AwsTable
{
public:
	TINT64 m_nUid;
	TbMail_operate_List m_bList;
	TbMail_operate_System_list m_bSystem_list;
	TbMail_operate_Al_list m_bAl_list;
	TINT64 m_nSeq;
...
public:
	TbMail_operate():AwsTable(&oTableDesc)
	{
		Reset();
	}
	~TbMail_operate()
	...
	{
		m_nSeq = nSeq;
		m_mFlag[TbMAIL_OPERATE_FIELD_SEQ] = dwActionType;
	}
	//Scan命令使用,返回完整的请求包
