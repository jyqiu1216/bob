#ifndef _AWS_TABLE_RANDOM_REWARD_H_
#define _AWS_TABLE_RANDOM_REWARD_H_

#include "aws_table_common.h"
#include "field_property.h"

#define EN_AWS_TABLE_RANDOM_REWARD "random_reward"

enum ETbRandom_rewardField
{
	TbRANDOM_REWARD_FIELD_UID = 0,
	TbRANDOM_REWARD_FIELD_TYPE = 1,
	TbRANDOM_REWARD_FIELD_NUM = 2,
	TbRANDOM_REWARD_FIELD_ETIME = 3,
	TbRANDOM_REWARD_FIELD_SEQ = 4,
};

enum ETbRandom_rewardOpenType
{
	ETbRANDOMREWARD_OPEN_TYPE_PRIMARY = 0,
};

class TbRandom_reward : public AwsTable
{
public:
	TINT64 m_nUid;
	TINT64 m_nType;
...
public:
	TbRandom_reward():AwsTable(&oTableDesc)
	{
		Reset();
	}
	~TbRandom_reward()
	...
	const TINT64& Get_Num()
	{
		return m_nNum;
	}
	void Set_Num(const TINT64& nNum, int dwActionType=UPDATE_ACTION_TYPE_PUT)
	{
		m_nNum = nNum;
		m_mFlag[TbRANDOM_REWARD_FIELD_NUM] = dwActionType;
	}
	...
	{
		m_nEtime = nEtime;
		m_mFlag[TbRANDOM_REWARD_FIELD_ETIME] = dwActionType;
	}
	...
	{
		m_nSeq = nSeq;
		m_mFlag[TbRANDOM_REWARD_FIELD_SEQ] = dwActionType;
	}
	//Scan命令使用,返回完整的请求包
