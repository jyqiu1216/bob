#ifndef _AWS_TABLE_DIPLOMACY_H_
#define _AWS_TABLE_DIPLOMACY_H_

#include "aws_table_common.h"
#include "field_property.h"

#define EN_AWS_TABLE_DIPLOMACY "diplomacy"

enum ETbDiplomacyField
{
	TbDIPLOMACY_FIELD_SRC_AL = 0,
	TbDIPLOMACY_FIELD_DES_AL = 1,
	TbDIPLOMACY_FIELD_TYPE = 2,
	TbDIPLOMACY_FIELD_SEQ = 3,
};

enum ETbDiplomacyOpenType
{
	ETbDIPLOMACY_OPEN_TYPE_PRIMARY = 0,
};

class TbDiplomacy : public AwsTable
{
public:
	TINT64 m_nSrc_al;
	TINT64 m_nDes_al;
...
public:
	TbDiplomacy():AwsTable(&oTableDesc)
	{
		Reset();
	}
	~TbDiplomacy()
	...
	const TINT64& Get_Src_al()
	{
		return m_nSrc_al;
	}
	void Set_Src_al(const TINT64& nSrc_al)
	{
		m_nSrc_al = nSrc_al;
	}
	const TINT64& Get_Des_al()
	{
		return m_nDes_al;
	}
	void Set_Des_al(const TINT64& nDes_al)
	{
		m_nDes_al = nDes_al;
	}
	...
	{
		m_nType = nType;
		m_mFlag[TbDIPLOMACY_FIELD_TYPE] = dwActionType;
	}
	...
	{
		m_nSeq = nSeq;
		m_mFlag[TbDIPLOMACY_FIELD_SEQ] = dwActionType;
	}
	//Scan命令使用,返回完整的请求包
