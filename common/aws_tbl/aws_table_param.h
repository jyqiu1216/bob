#ifndef _AWS_TABLE_PARAM_H_
#define _AWS_TABLE_PARAM_H_

#include "aws_table_common.h"
#include "field_property.h"

#define EN_AWS_TABLE_PARAM "param"
...
enum ETbParamOpenType
{
	ETbPARAM_OPEN_TYPE_PRIMARY = 0,
};

class TbParam : public AwsTable
{
public:
	TINT64 m_nKey;
	TINT64 m_nVal;
...
public:
	...
	const TINT64& Get_Val()
	{
		return m_nVal;
	}
	void Set_Val(const TINT64& nVal, int dwActionType=UPDATE_ACTION_TYPE_PUT)
	{
		m_nVal = nVal;
		m_mFlag[TbPARAM_FIELD_VAL] = dwActionType;
	}
	...
	{
		m_nSeq = nSeq;
		m_mFlag[TbPARAM_FIELD_SEQ] = dwActionType;
	}
	//Scan命令使用,返回完整的请求包
