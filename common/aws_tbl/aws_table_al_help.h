#ifndef _AWS_TABLE_AL_HELP_H_
#define _AWS_TABLE_AL_HELP_H_

#include "aws_table_common.h"
#include "field_property.h"

#define EN_AWS_TABLE_AL_HELP "al_help"

enum ETbAl_helpField
{
	TbAL_HELP_FIELD_UID = 0,
	TbAL_HELP_FIELD_IDX = 1,
	TbAL_HELP_FIELD_LIST = 2,
	TbAL_HELP_FIELD_SEQ = 3,
};

enum ETbAl_helpOpenType
{
	ETbALHELP_OPEN_TYPE_PRIMARY = 0,
};

#define	TBAL_HELP_LIST_MAX_NUM	1
typedef	BinBuf<SAlHelpList, TBAL_HELP_LIST_MAX_NUM>		TbAl_help_List;

class TbAl_help : public AwsTable
{
public:
	TINT64 m_nUid;
	TINT64 m_nIdx;
	TbAl_help_List m_bList;
	TINT64 m_nSeq;
...
public:
	...
	const TINT64& Get_Idx()
	{
		return m_nIdx;
	}
	void Set_Idx(const TINT64& nIdx)
	{
		m_nIdx = nIdx;
	}
	...
	{
		m_nSeq = nSeq;
		m_mFlag[TbAL_HELP_FIELD_SEQ] = dwActionType;
	}
	//Scan命令使用,返回完整的请求包
